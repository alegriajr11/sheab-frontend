...
@Component({
  selector: 'app-modal-firma-acta-pamec',
  templateUrl: './modal-firma-acta-pamec.component.html',
  styleUrls: ['./modal-firma-acta-pamec.component.css']
})
export class ModalFirmaActaPamecComponent {
