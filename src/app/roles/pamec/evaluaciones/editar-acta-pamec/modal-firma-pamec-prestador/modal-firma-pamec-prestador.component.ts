...
@Component({
  selector: 'app-modal-firma-pamec-prestador',
  templateUrl: './modal-firma-pamec-prestador.component.html',
  styleUrls: ['./modal-firma-pamec-prestador.component.css']
})
export class ModalFirmaPamecPrestadorComponent {
  ...
  guardarFirma() {
    ...
    this.sharedService.setFirmaActaPamec(this.firma);
