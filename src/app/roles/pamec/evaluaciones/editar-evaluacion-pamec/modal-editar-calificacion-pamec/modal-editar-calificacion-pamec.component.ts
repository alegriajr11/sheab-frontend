...
@Component({
  selector: 'app-modal-editar-calificacion-pamec',
  templateUrl: './modal-editar-calificacion-pamec.component.html',
  styleUrls: ['./modal-editar-calificacion-pamec.component.css']
})
export class ModalEditarCalificacionPamecComponent {
