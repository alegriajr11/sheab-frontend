...
@Component({
  selector: 'app-modal-firma-verificacion',
  templateUrl: './modal-firma-verificacion.component.html',
  styleUrls: ['./modal-firma-verificacion.component.css']
})
export class ModalFirmaVerificacionComponent {
  ...
  capturarFirma() {
    if (this.signaturePad.isEmpty()) {
      ...
      this.sharedService.setFirmaActaVisitaVerificacion(this.firma);
