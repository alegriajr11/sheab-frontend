...
@Component({
  selector: 'app-modal-firma-acta-sp-pro',
  templateUrl: './modal-firma-acta-sp-pro.component.html',
  styleUrls: ['./modal-firma-acta-sp-pro.component.css']
})
export class ModalFirmaActaSpProComponent {
