...
@Component({
  selector: 'app-modal-editar-firma-sp-ips',
  templateUrl: './modal-editar-firma-sp-ips.component.html',
  styleUrls: ['./modal-editar-firma-sp-ips.component.css']
})
export class ModalEditarFirmaSpIpsComponent {
