...
@Component({
  selector: 'app-modal-editar-firma-acompanante-sp-ips',
  templateUrl: './modal-editar-firma-acompanante-sp-ips.component.html',
  styleUrls: ['./modal-editar-firma-acompanante-sp-ips.component.css']
})
export class ModalEditarFirmaAcompananteSpIpsComponent {
  ...
  capturarFirma() {
    if (this.signaturePad.isEmpty()) {
      ...
      this.firma_acompanante = firmaDataURL;
      this.sharedService.setFirmaActaSpIpsAcompanante(this.firma_acompanante);
    ...
    if (imagen) {
      ...
      if (imagen.size <= 60 * 1024) {
        ...
        reader.onload = (e: any) => {
          ...
          this.firma_acompanante = imagenBase64
          this.sharedService.setFirmaActaSpIpsAcompanante(this.firma_acompanante);
        };
